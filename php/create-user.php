...
$c->query("INSERT INTO users (id, phone, email, password, confirmed, name, profile_picture_url, active_connections, username, city, end_date, is_trial, maximum_connections, made_in) VALUES ('" . uniqid() . "', '" . $phone . "', '" . $email . "', '" . $password . "', " . $confirmed . ", '" . $name . "', '" . $profilePictureURL . "', " . $activeConnections . ", '" . $username . "', '" . $city . "', " . $endDate . ", " . $trial . ", " . $maxConnections . ", " . round(microtime(true)*1000) . ")");
echo 0;