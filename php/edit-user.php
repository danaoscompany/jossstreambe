...
$c->query("UPDATE users SET phone='+6281987654321', password='Hello456', confirmed=1, name='User Name 6', username='username6', profile_picture_url='http://www.google.com', city='Sidoarjo', end_date=1558890000000, is_trial=1, active_connections=10, maximum_connections=20 WHERE id='ajxqNQ5zlZXUL7kjHEzxZ8qnURj2'");
echo 0;